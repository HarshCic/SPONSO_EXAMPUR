<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['submit'])) {
      ...
      $image = "pdfthumbnail.png";
      $target = "../LiveCourse/PDF/Images/".$image;
      $pdfimage=$GLOBALS['serverimage']."Livecourse/PDF/Images/".$image;
      $sql = "INSERT INTO `live_course_class`(`Title`, `material_type`, `file_link`, `thumbnail`, `course_id`, `live_status`, `exam`, `subject`, `topic`, `concept`, `section`, `pdf_link`, `date_and_time`, `download_link`) VALUES ('".$_POST['title']."', 'PDF', '".$_POST['link']."', '".$pdfimage."', '".$_POST['course']."', '3', '".$_POST['exam']."', '".$_POST['subject']."', '".$_POST['topic']."', '".$_POST['concept']."', '".$_POST['section']."', '".$_POST['link']."', '".$mydate."', '".$_POST['link']."')";
