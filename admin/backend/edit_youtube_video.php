...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $query="UPDATE `youtube_class` SET  `Title`='$title',`material_type`='$type',`file_link`='$video_link',`live_status`='$status',`exam_id`='$exam_id',`subject`='$subject_id',`topic`='$topic_id',`concept`='$concept_id',`download_link`='$download_link'  WHERE id='$id'";
      ...
      <div class="row">
        ...
        <form role="form" method="post">
          ...
          <div class="form-group">
            ...
            <option value="1" <?php if($fetch["live_status"]==1){ echo "selected"; } ?>>Live</option>
               <option value="2"  <?php if($fetch["live_status"]==2){ echo "selected"; } ?>>Recorded</option>
               <option value="3"  <?php if($fetch["live_status"]==3){ echo "selected"; } ?>>Upcoming</option>
            </select>
          </div>
