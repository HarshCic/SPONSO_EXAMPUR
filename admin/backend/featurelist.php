   ...
   <section class="content">
      <div class="row">
         <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
               <div class="col-md-12 table-responsive p-0 m-0">
                  <table class="table table-bordered datatable example table-striped">
                     <thead>
                        <tr>
                          ...
                          <th>Date and Time</th>
                          <th>Title</th>
                          <th class="text-justify">Link</th>
                          <th>Live Status</th>
                          <th class="text-justify">Download Link</th>
                          <th>Delete</th>
                          <th>Edit</th>
                        </tr>
                     </thead>
                     <tbody>
                        <?php $i=1; while ($fetch=mysqli_fetch_array($query,MYSQLI_ASSOC)) { ?>
                        <tr>
                          <td><?php echo $i++; ?></td>
