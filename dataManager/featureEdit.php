...
?>
<?php
$query=mysqli_query($ses,"SELECT * FROM featured_video ORDER BY id DESC LIMIT $start_from,$num_per_page ");
 ?>
<!DOCTYPE html>
  ...
  <div id="wrapper" class="toggled">
      <div class="container-fluid">
          ...
          <div class="container table-responsive">
            ...
            if ($page>1) {
              echo "<a href='featureEdit.php?page=".($page-1)."'class='btn btn-primary'>Previous</a>";
            }
            for ($i=1; $i <=$total_page ; $i++) {
              echo "<a href='featureEdit.php?page=".$i."'class='btn btn-info'>$i</a>";
            }
            if ($i-1>$page) {
              echo "<a href='featureEdit.php?page=".($page+1)."'class='btn btn-primary'>Next</a>";
            }
            echo '<hr>';
            echo "Page-".$page;
             ?>
